            ...
            function(res){
                ...
                if(that.data.alarmdetailData.finalresult1.length > 0){
                   // for(var i = 0;i < that.data.alarmdetailData.finalresult1.length;i++){
                       ...
                       //
                       // const x1 = that.data.alarmdetailData.finalresult1[1].x;
                       // const y1 = that.data.alarmdetailData.finalresult1[1].y;
                       // const w1 = that.data.alarmdetailData.finalresult1[1].w;
                       // const h1 = that.data.alarmdetailData.finalresult1[1].h;
